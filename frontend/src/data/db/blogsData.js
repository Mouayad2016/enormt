const db = [
  {
    ...
    type: 'Webinar',
    title:
      'Från idé till verklighet: Så lyckas du med din första mobil- & webbapp',
    ...
    keywords:
      'Första mobilapp, Första webbapp, Minimal Viable Product, ChatGPT-integrering, Kravspecifikation, Utvecklingsstrategier, Idé till verklighet',
    ...
    page: {
      ...
      citat:
        'Syftet är att snabbt få en produkt på marknaden för att testa de grundläggande funktionerna, och effektivt kunna validera eller falsifiera affärsidéen.',
