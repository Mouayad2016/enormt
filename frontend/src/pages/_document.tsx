    ...
    return (
      <Html lang="sv">
        <Head>
          ...
          <link rel="icon" type="image/png" sizes="32x32" href="/assets/img/enormt/logo/favicon-32x32.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/assets/img/enormt/logo/favicon-16x16.png" />
          <link rel="manifest" href="/assets/img/enormt/logo/site.webmanifest" />
...
{/* New OG and Twitter meta tags */}
          ...
          <meta property="og:description" content="Funderar du på att investera i en hemsida, mobilapputveckling, ett IT-system eller behöver IT-konsultation? Vi är Nordens bästa utvecklare. Kontakta oss idag!."/>
          ...
          <meta name="twitter:description" content="Funderar du på att investera i en hemsida, mobilapputveckling, ett IT-system eller behöver IT-konsultation? Vi är Nordens bästa utvecklare. Kontakta oss idag!."/>
        ...
        <body>
          <noscript>
            It looks like you have JavaScript disabled in your web browser. Our app
            requires JavaScript to function properly, so please enable it and reload
            the page. If you need help enabling JavaScript, please refer to your web
            browsers documentation or search online for instructions.
          </noscript>
          <Main />
          <NextScript />
        </body>
