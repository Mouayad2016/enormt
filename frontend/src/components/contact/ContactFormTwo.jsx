...
const ContactFormTwo = () => {
	...
	return (
		<>
			<section id='contact-us-form' className='contact-us-form pt-0 pb-100'>
				<buble></buble>
						...
						<div className='col-lg-6 col-md-8'>
							<div className='section-heading '>
								...
								<p className='text-dark res-fs-5'>
									Kontakta oss här så återkopplar vi så snart som möjligt. Du
									kan kontakta oss direkt via följande <br></br>
									<a href='mailto:info@enormt.se'>info@enormt.se</a> eller
