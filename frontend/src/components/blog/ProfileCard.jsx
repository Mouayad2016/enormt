    ...
    <>
      <div className="author-wrap text-center sticky-sidebar rounded-custom mt-5 mt-lg-0">
        <div className="bg-light p-3 rounded-custom">
          <Image
            src={`/assets/img/enormt/about/team/mouayad2.jpg`}
            alt="author"
            width={120}
            height={120}
          ...
          <p className="fs-ms">
            Teknologi är avgörande och vi bör alla ha tillgång till det. Det är
            mitt uppdrag att upprätthålla kvaliteten på Enormt, samtidigt som
            jag strävar efter att skapa mervärde för våra kunder genom att dela
            vår interna process.
          </p>
