							...
							<div className='col-lg-8 col-md-9'>
								<div className='subscribe-info-wrap text-center position-relative z-2'>
									<div className='section-heading'>
										<h4 className='h5 text-body'>Visst är det spännande!</h4>
										<h2 className='text-body'>
											Anmäl dig till kommande webinare
										</h2>
										<p>
											Skicka din e-post så mejlar vi dig om våra framkommande
											webinar. För att inte missa följ oss på{" "}
											<a href='https://www.linkedin.com/company/enormt-se/mycompany/?viewAsMember=true'>
												Linkedin
											</a>
											.
										</p>
									...
									<div className='form-block-banner web-reg-news-letter-mw m-auto mt-5'>
										...
										{submitStatus === true ? (
											...
											<p className='error-message'>
												Oops! Fel inträffat! Lyckades du inte registrera dig?
												Ring oss på <a href='tel:+46733524957'>0733524957</a> så
												fixar vi det.
											</p>
									...
									<ul className='nav justify-content-center subscribe-feature-list mt-3'>
										<li className='nav-item'>
											<span>
												...
												Oroa inte dig! du kommer bara får mejl angående kommande
												webbseminarium
											</span>
										</li>
									</ul>
