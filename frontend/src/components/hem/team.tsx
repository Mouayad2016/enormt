        ...
        <section className="bg-main-pink hero-nine-bg ptb-120">
            <div className="container">
                <div className="counter-content section-title mb-30 lh-1">
                    <h2 className="mb-md-5 text-dark justify-content-center text-center">Våra fasta priser</h2>
                    <h2 className="mb-4 text-body fs-2">
                        Skalbara Webblösningar för Växande Affärsbehov 
                        <span className="fw-bold text-info"> 12 mån garanti</span> och <span className="text-info fw-bold">6 månader IT-suppor</span>
                    </h2>
                    <p className="fs-5">
                        Vi är experter på hemsidor och jobbar med allt från <span className="text-omaina-green fw-bold"> JavaScript </span>  
                    ...
                    <p className="fs-6 text-dark">
                        Om du söker en lösning som inte finns i våra paket, eller önskar en mer anpassad hemsida, är du välkommen att kontakta oss.
                    </p>
                </div>
            </div>
