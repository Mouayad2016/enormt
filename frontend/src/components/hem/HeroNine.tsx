        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-10">
            <div className="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
              ...
              Vi stöttar våra klienter genom den digitala transformationen och erbjuder högkvalitativa, skräddarsydda lösningar. Med <span className='text-info fw-bolder'><i className="fas fa-check"></i> 12 månaders garanti  </span>och <span className='text-info fw-bolder'><i className="fas fa-check"></i> 6 månaders IT-support</span> är vår ambition att leverera innovativa och säkra lösningar för en mer hållbar framtid              </p>
