        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-10">
            <div className="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
              <h1 className="fw-bold display-5 text-dark pt-5">Vi Ta Ditt Företag Till Nästa Nivå</h1>
              <p className="text-dark fs-5">
              Vi stöttar våra klienter genom den digitala transformationen och erbjuder högkvalitativa, skräddarsydda lösningar. Med <br></br><span className='text-info fw-bolder'>🗸 12 månaders garanti </span>och <span className='text-info fw-bolder'>🗸 6 månaders IT-support</span> är vår ambition att leverera innovativa och säkra lösningar för en mer hållbar framtid              </p>
