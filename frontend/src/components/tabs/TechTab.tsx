...
const TechTab = () => {
	const [selectedTab, setSelectedTab] = useState(
		data.length ? data[0].hem_sida.namn : null
	);
				...
				<div className='row justify-content-center'>
					<div className='col-lg-6 col-md-6'>
						<div className='text-center'>
							<h2 className='text-dark'>Skräddarsydda IT-lösningar</h2>
							<p className='res-fs-5'>
								Dyk ner i det omfattande utbud av IT-tjänster vi erbjuder och
								upptäck hur vår breda expertis kan tillgodose just dina unika
								behov{" "}
							</p>
						</div>
					</div>
												...
												<div className='row align-items-center justify-content-center'>
													<div className='col-md-4'>
														<div className={e.hem_sida.tabs.className2}>
															<Pyramid
																className={`${e.hem_sida.namn} display-none-on-mobile`}
															></Pyramid>
														</div>
													</div>
													<div className='col-md-6'>
														<div className='tab-right-content'>
															...
															<p className='res-fs-5 text-dark'>
																{e.hem_sida.tabs.des}
															</p>
