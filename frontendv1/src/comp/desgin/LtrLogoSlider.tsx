...
const LtrLogoSlider = ({ slides }: any) => {
	...
	useEffect(() => {
		const handleScroll = () => {
			...
			const newScrollLeft = (1 - scrollTop / maxScroll) * maxScrollLeft;
	...
	return (
		<div className={`slider-container flex ${isRTL ? "rtl" : "ltr"}`}>
			<div
